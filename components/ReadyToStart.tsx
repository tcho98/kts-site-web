...
export default function ReadyToStart() {
  return (
    <div className="bg-yellow-300  to-orange-500 py-10 p-10">
      <div className="z-10 max-w-7xl relative mx-auto w-full px-4 md:px-6 lg:px-8">
        ...
        >
          ...
          <span className="transform text-4xl text-black flex justify-center items-center w-12 h-12 rounded-full bg-white transition-all duration-300 group-hover:bg-blue-400 group-hover:text-white">
            →
          </span>
        </Link>
      </div>
