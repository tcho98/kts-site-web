      ...
      items: [
        {
          ...
          stats: [
            { value: 97, suffix: "%", description: " Client Satisfaction" },
            {
              value: 25,
              suffix: "%",
              description: "Reduction in Transit Time",
            },
          ],
        },
      ],
  ...
  return (
    <main className="bg-gray-300  overflow-x-hidden">
      ...
      <section className="sm:max-w-5xl max-w-lg mx-auto p-4">
        <h1
          className="text-3xl text-gray-700 font-bold text-center mt-10 mb-5"
          id="mission"
        >
          Our Mission
        </h1>
        <p className="text-center text-gray-700 text-4xl font-bold">
          Partnering with parents to provide safe, reliable, and high-quality
          mobility and education services together with customized concierge
          solutions that give them freedom and flexibility in the management of
          their kids.
        </p>
      </section>

      <section className="sm:max-w-7xl max-w-lg mx-auto p-4 bg-white mt-10">
        <p className="text-center text-black font-bold lg:text-3xl" id="values">
          Our Values
        </p>
